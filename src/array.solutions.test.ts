...
describe('map', () => {
  ...
  describe('map method', () => {
    ...
    it('should return a new array with updated objects', () => {
      ...
      const updatedArr = _.cloneDeep(arr).map(item => {
        item.views++;
        return item;
      });
  ...
  describe('reduce method', () => {
    ...
    it('should return a total number, adding all of the views', () => {
      ...
      const total = arr.reduce((totalViews, item) => {
  ...
  describe('sort method', () => {
    it('should return an alphabetized list', () => {
      const arr = ['d', 'b', 'a', 'c'];
      const alphabetized = arr.sort((a, b) => {
        if (a < b) return -1;
        if (b < a) return 1;
        return 0;
      });
